    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('section', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='hip_prosthesis.hipsection', verbose_name='Секция')),
            ],
            options={
