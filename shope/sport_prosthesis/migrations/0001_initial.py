    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('section', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='sport_prosthesis.sportsection', verbose_name='Секция')),
            ],
            options={
